...
| T08 | [T08-model-and-domain-strategy.md](T08-model-and-domain-strategy.md) | 待指定（Agent 负责人） | 进行中（T14 作业调用 Interface 修补中） |
| T10 | [T10-frontend-core.md](T10-frontend-core.md) | Codex | 进行中（会话与目标创建/详情切片） |
| T14 | [T14-model-config.md](T14-model-config.md) | Giraffe12311 | 进行中（#26/#28 已合并；作业调用 Interface 修补中） |
